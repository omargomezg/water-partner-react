...
const menuItems = [
	...
	},
	{
		...
		children: [
			...
			{
				key: '/configurations/category/list',
				label: <Link to="/configurations/category/list">Categorías</Link>,
			},
			...
			{
				key: '/configurations/accounts',
				label: <Link to="/configurations/accounts">Cuentas de Usuario</Link>,
			},
		],
	},
];

...
export const ListOfCategoriesPage: FC = () => {
  ...
  return (
    <>
      ...
      <Text>
        Las categorías son divisiones o grupos que se establecen para clasificar
        y organizar elementos, ya sean objetos, ideas, palabras o conceptos,
        facilitando su búsqueda y comprensión. Se usan en diversos campos como
        la filosofía (para clasificar la realidad), la gramática (para agrupar
        palabras), la administración (para organizar tareas) o el comercio
